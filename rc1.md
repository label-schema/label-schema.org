...
| `os-id` | `org.label-schema.os-id = "ubuntu"` | Identifier of the operating system distribution. In case of building a base image, ie with no parent, use "custom". |
| `os-version-id` | `org.label-schema.os-version-id = "14.04"` | Identifier of the operating system distribution version. In case of building a base image, ie with no parent, use "none". |
